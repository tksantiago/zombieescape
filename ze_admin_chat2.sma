...
public HookSay(id)
{
	...
	if(temp_prefix[0])
	{
		formatex(g_message, charsmax(g_message), "^1%s^4[LV. %d] ^4%s^3 %s :^4 %s", say_team_info[is_user_alive(id)][g_team], get_user_level(id), temp_prefix, g_name, g_typed)
	}
	else if(get_user_level(id) >= 60)
	{
		formatex(g_message, charsmax(g_message), "^1%s^4[LV. %d] ^4[OLD PLAYER]^3 %s :^4 %s", say_team_info[is_user_alive(id)][g_team], get_user_level(id), g_name, g_typed)
	}
	else if(get_cvar_num("freevip_hour"))
	{
		formatex(g_message, charsmax(g_message), "^1%s^4[LV. %d] ^4[FREE VIP]^3 %s :^1 %s", say_team_info[is_user_alive(id)][g_team], get_user_level(id), g_name, g_typed)
	}
	else
	{
		formatex(g_message, charsmax(g_message), "^1%s^4[LV. %d]^3 %s :^1 %s", say_team_info[is_user_alive(id)][g_team], get_user_level(id), g_name, g_typed)
	}
...
public HookSayTeam(id)
{
	...
	if(temp_prefix[0])
	{
		formatex(g_message, charsmax(g_message), "^1%s^4[LV. %d] ^4%s^3 %s :^4 %s", sayteam_team_info[is_user_alive(id)][g_team], get_user_level(id), temp_prefix, g_name, g_typed)
	}
	else if(get_user_level(id) >= 60)
	{
		formatex(g_message, charsmax(g_message), "^1%s^4[LV. %d] ^4[OLD PLAYER]^3 %s :^4 %s", sayteam_team_info[is_user_alive(id)][g_team], get_user_level(id), g_name, g_typed)
	}
	else if(get_cvar_num("freevip_hour"))
	{
		formatex(g_message, charsmax(g_message), "^1%s^4[LV. %d] ^4[FREE VIP]^3 %s :^1 %s", sayteam_team_info[is_user_alive(id)][g_team], get_user_level(id), g_name, g_typed)
	}
	else
	{
		formatex(g_message, charsmax(g_message), "^1%s^4[LV. %d]^3 %s :^1 %s", sayteam_team_info[is_user_alive(id)][g_team], get_user_level(id), g_name, g_typed)
	}
