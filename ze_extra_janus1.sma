...
public plugin_init()
{
	...
	item_janus1 = zp_register_extra_item("Janus-1", 50, ZP_TEAM_HUMAN)
	
	cvar_dmg_janus1 = register_cvar("zp_janus1_dmg", "150.0")
	cvar_ammo_janus1 = register_cvar("zp_janus1_ammo", "250")
}
