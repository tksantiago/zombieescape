...
#define DAMAGE_BALL_1		500.0
#define DAMAGE_BALL_2		1000.0
#define DAMAGE_BALL_3		1500.0
...
#define EXTRA_ITEM_PRICE	70

new gMaxPlayers, Msg_WeaponList, g_AllocString_V, g_laserminigun
...
public plugin_init()
{
	...
	g_laserminigun = zp_register_extra_item(EXTRA_ITEM_NAME, EXTRA_ITEM_PRICE, ZP_TEAM_HUMAN)
}
